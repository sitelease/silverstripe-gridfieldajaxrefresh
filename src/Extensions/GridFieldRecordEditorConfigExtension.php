...
/**
 * Automatically integrates the ajax refresh button into the RecordEditor {@link GridField} config
 */
class GridFieldRecordEditorConfigExtension extends Extension
{
